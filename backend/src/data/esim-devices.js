 ...
 * Source: Apple, Samsung, Google, Huawei, Xiaomi official specs
 * Updated: April 2026
 */
...
const ESIM_DEVICES = [
  ...
  { brand: 'Apple', model: 'iPad Pro 12.9-inch (3rd gen+)' },
  { brand: 'Apple', model: 'iPad Pro 11-inch (1st gen+)' },
  { brand: 'Apple', model: 'iPad Air (3rd gen+)' },
  { brand: 'Apple', model: 'iPad (7th gen+)' },
  ...
  { brand: 'Samsung', model: 'Galaxy S20' },
  { brand: 'Samsung', model: 'Galaxy Z Fold 6' },
  { brand: 'Samsung', model: 'Galaxy Z Fold 5' },
  { brand: 'Samsung', model: 'Galaxy Z Fold 4' },
  { brand: 'Samsung', model: 'Galaxy Z Fold 3' },
  { brand: 'Samsung', model: 'Galaxy Z Fold 2' },
  { brand: 'Samsung', model: 'Galaxy Z Fold' },
  { brand: 'Samsung', model: 'Galaxy Z Flip 6' },
  { brand: 'Samsung', model: 'Galaxy Z Flip 5' },
  { brand: 'Samsung', model: 'Galaxy Z Flip 4' },
  { brand: 'Samsung', model: 'Galaxy Z Flip 3' },
  ...
  { brand: 'Sony', model: 'Xperia 5 V' },
  { brand: 'Sony', model: 'Xperia 5 IV' },
  { brand: 'Sony', model: 'Xperia 10 V' },
  ...
  { brand: 'OPPO', model: 'Reno 9 Pro+' },

  // ── Other ──
  { brand: 'Nokia', model: 'XR21' },
  { brand: 'Nokia', model: 'X30' },
  { brand: 'Honor', model: 'Magic 5 Pro' },
  { brand: 'Honor', model: 'Magic V2' },
];

module.exports = ESIM_DEVICES;
