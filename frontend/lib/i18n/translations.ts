const translations = {
  sq: {
    ...
    "refund.s3.text": "Për të kërkuar rimbursim, ju lutem kontaktoni ekipin tonë të mbështetjes në support@shqiponjaesim.com me ID-në e Porosisë tuaj dhe një përshkrim të detajuar të problemit. Ekipi ynë do të verifikojë statusin e aktivizimit të eSIM-it me ofruesin tonë të rrjetit përpara miratimit të rimbursimit.",
  ...
  en: {
    ...
    "refund.s3.text": "To request a refund, please contact our support team at support@shqiponjaesim.com with your Order ID and a detailed description of the issue. Our team will verify the activation status of the eSIM with our network provider before approving the refund.",
