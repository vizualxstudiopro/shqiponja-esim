const translations = {
  sq: {
    ...
    "terms.s6.title": "6. Ligji i Aplikueshëm dhe Juridiksioni",
    "terms.s6.text": "Këto Kushte Përdorimi rregullohen nga ligjet e Shtetit të Wyoming, SHBA. Çdo mosmarrëveshje do të zgjidhet ekskluzivisht në gjykatat shtetërore ose federale të vendosura në Cheyenne, Wyoming.",
    ...
    "imprint.legal.item2": "Forma: Limited Liability Company",
  ...
  en: {
    ...
    "terms.s6.title": "6. Applicable Law and Jurisdiction",
    "terms.s6.text": "These Terms of Use are governed by the laws of the State of Wyoming, USA. Any dispute will be resolved exclusively in the state or federal courts located in Cheyenne, Wyoming.",
    ...
    "imprint.legal.item2": "Form: Limited Liability Company",
    "imprint.legal.item3": "Brand: Shqiponja eSIM",
