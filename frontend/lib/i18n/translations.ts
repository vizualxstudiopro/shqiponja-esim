const translations = {
  sq: {
    ...
    "terms.s6.text": "You must be at least 18 years old to purchase. These Terms are governed by Wyoming law, USA. Any dispute will be resolved exclusively in courts in Cheyenne, Wyoming.",
    ...
    "privacy.retention.text": "We retain order and billing data for 7 years to comply with IRS tax law. Customer support messages are deleted after 90 days.",
    "privacy.children.title": "Children’s Privacy",
    "privacy.children.text": "Our service is not directed to users under 18. We do not knowingly collect data from minors.",
    ...
    "buy.emailHint": "eSIM-i dhe QR kodi do të dërgohen në këtë adresë.",
    "buy.optional": "opsional",
  ...
  en: {
    ...
    "buy.emailHint": "Your eSIM and QR code will be sent to this address.",
    "buy.optional": "optional",
