      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        <div className="text-center">
          ...
          <div className="mb-6 flex justify-center">
            <img
              src="/tournaments_fifa-world-cup-2026--white.football-logos.cc.svg"
                  ...
                  >
                    ...
                    <div className="flex flex-1 flex-col justify-between p-5">
                      ...
                      <div className="mt-4 flex items-center gap-1.5 border-t border-white/10 pt-4">
                        ...
                        <a href={messengerShare(url)} target="_blank" rel="noopener noreferrer" onClick={(e) => e.stopPropagation()}
                          className="flex h-7 w-7 items-center justify-center rounded-full bg-[#0099FF]/20 text-[#4db8ff] transition hover:bg-[#0099FF] hover:text-white" aria-label="Messenger">
                          <MessengerIcon />
                        </a>
                      </div>
                    </div>
