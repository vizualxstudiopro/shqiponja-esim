          ...
          <div className="flex flex-1 flex-col justify-between p-4">
            ...
            <div className="mt-3 flex items-center gap-1.5 border-t border-zinc-100 pt-3 dark:border-zinc-700">
              ...
              <a href={messengerShare(url)} target="_blank" rel="noopener noreferrer" onClick={(e) => e.stopPropagation()}
                className="flex h-7 w-7 items-center justify-center rounded-full bg-[#0099FF]/10 text-[#0099FF] transition hover:bg-[#0099FF] hover:text-white" aria-label="Messenger">
                <MessengerIcon />
              </a>
            </div>
          </div>
